...
For two active charts of one finite controlled boundary partition, this file
compares their chosen real boundary lifts at an overlap point.  Canonical
center parameters provide the concrete chart-transition overlap, continuity
shrinks it to the two selected lift intervals, and conventional chart-sign
parity determines whether the transition preserves or reverses direction.
-/

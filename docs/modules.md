...
| Area and Jacobians | `EuclideanAreaFormula`, `ComplexAreaFormula`, `RiemannianTwoJacobian`, `RiemannianAreaFormula`, `RiemannianChartArea`, `RiemannianAtlasArea`, `JacobianBudget`, `ComplexJacobianBudget` | planar area formula, intrinsic pointwise `J₂`, Riemannian chain rule, one-chart area measure and integral transfer, countable-atlas coverage, exact planar bridge, and determinant budgets |

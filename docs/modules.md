...
| Coverage | `SurfaceCoverage`, `MetricPlanarCoverage`, `RiemannianInteriorCoverage`, `Lemma54Area` | abstract and metric Jordan coverage, interior preimages, and the full current Lemma 3.4 area inequality |

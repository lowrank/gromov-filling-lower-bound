...
| Area and Jacobians | `EuclideanAreaFormula`, `ComplexAreaFormula`, `RiemannianTwoJacobian`, `RiemannianAreaFormula`, `RiemannianChartArea`, `JacobianBudget`, `ComplexJacobianBudget` | planar area formula, intrinsic pointwise `J₂`, Riemannian chain rule, one-chart area measure and integral transfer, exact planar bridge, and determinant budgets |

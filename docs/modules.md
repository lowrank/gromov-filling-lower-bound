...
| Area and Jacobians | `EuclideanAreaFormula`, `ComplexAreaFormula`, `RiemannianTwoJacobian`, `RiemannianAreaFormula`, `RiemannianChartArea`, `RiemannianAtlasArea`, `RiemannianChartTransition`, `JacobianBudget`, `ComplexJacobianBudget` | planar area formula, intrinsic pointwise `J₂`, Riemannian chain rule, one-chart area measure and integral transfer, countable-atlas coverage, chart-transition invariance, exact planar bridge, and determinant budgets |

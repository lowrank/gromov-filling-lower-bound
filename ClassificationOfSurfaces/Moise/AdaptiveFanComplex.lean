...
theorem extendFaceCoordinates_eq_center_add_smul_normalizedBase (hU : IsOpen U)
  ...
  have hfirst : d •
        (Pi.single (K.adaptiveFanFirstVertex U hU f).1
          (x (K.adaptiveFanFirstVertex U hU f) / d) : K.realization → ℝ) =
      (Pi.single (K.adaptiveFanFirstVertex U hU f).1
        (x (K.adaptiveFanFirstVertex U hU f)) : K.realization → ℝ) := by
    funext v
  ...
  have hsecond : d •
        (Pi.single (K.adaptiveFanSecondVertex U hU f).1
          (x (K.adaptiveFanSecondVertex U hU f) / d) : K.realization → ℝ) =
      (Pi.single (K.adaptiveFanSecondVertex U hU f).1
        (x (K.adaptiveFanSecondVertex U hU f)) : K.realization → ℝ) := by
    funext v
  ...
  change
    (Pi.single (K.adaptiveFanCenterVertex U hU f).1
          (x (K.adaptiveFanCenterVertex U hU f)) : K.realization → ℝ) +
        (Pi.single (K.adaptiveFanFirstVertex U hU f).1
          (x (K.adaptiveFanFirstVertex U hU f)) : K.realization → ℝ) +
      (Pi.single (K.adaptiveFanSecondVertex U hU f).1
          (x (K.adaptiveFanSecondVertex U hU f)) : K.realization → ℝ) =
      (Pi.single (K.adaptiveFanCenterVertex U hU f).1
          (x (K.adaptiveFanCenterVertex U hU f)) : K.realization → ℝ) +
        ((1 - x (K.adaptiveFanCenterVertex U hU f)) •
            (Pi.single (K.adaptiveFanFirstVertex U hU f).1
              (x (K.adaptiveFanFirstVertex U hU f) /
                (1 - x (K.adaptiveFanCenterVertex U hU f))) : K.realization → ℝ) +
          (1 - x (K.adaptiveFanCenterVertex U hU f)) •
            (Pi.single (K.adaptiveFanSecondVertex U hU f).1
              (x (K.adaptiveFanSecondVertex U hU f) /
                (1 - x (K.adaptiveFanCenterVertex U hU f))) : K.realization → ℝ))
...
theorem adaptiveFanExtendedCoordinates_eq_of_faceMap_eq_of_tile_ne_of_base_weights_pos
  ...
  change (K.adaptiveFanBasePath U hU f rx).1.1 =
    (K.adaptiveFanBasePath U hU g ry).1.1 at hcoordEq

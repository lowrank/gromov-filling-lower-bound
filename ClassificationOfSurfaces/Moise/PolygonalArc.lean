...
import ClassificationOfSurfaces.Compat.Convex
...
theorem resolvedComplex_support : B.resolvedComplex.support = B.resolvedCarrier := by
  ...
  · have hpathNil : B.resolvedWalk.Nil :=
      SimpleGraph.Walk.nil_iff_length_eq.mpr hzero
...
noncomputable def realAxisAffine : ℝ →ᵃ[ℝ] Plane := realAxisLinear.toAffineMap

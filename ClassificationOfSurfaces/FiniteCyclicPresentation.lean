...
theorem twoMonogonSphere_boundary_injective
  ...
  · rfl
  · exfalso
    have hm := h.mem_iff (a := (.pos 0))
    change
      (.pos 0 : SignedDart (Fin 1)) ∈ twoMonogonSphere.boundary 0 ↔
        (.pos 0 : SignedDart (Fin 1)) ∈ twoMonogonSphere.boundary 1 at hm
    simp at hm
  · exfalso
    have hm := h.mem_iff (a := (.neg 0))
    change
      (.neg 0 : SignedDart (Fin 1)) ∈ twoMonogonSphere.boundary 1 ↔
        (.neg 0 : SignedDart (Fin 1)) ∈ twoMonogonSphere.boundary 0 at hm
    simp at hm
  · rfl

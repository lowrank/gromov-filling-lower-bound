/-
Vendored from rkirov/jordan_pick at commit
b141748187099368d1b564de5fc6601026255378.
Released there under the Apache License 2.0.
Adapted for the repository's Lean 4.29 compatibility target.
-/
...
lemma param_surjective : Surjective param :=
  circleHomeoSphere.surjective.comp Circle.surjOn_exp_neg_pi_pi.surjective

/-
Parts of this file are derived from Álvaro Begué's Schoenflies development.
...
import Wikipedia.SchoenfliesTheorem.PolyArcRealize
...
and the trust audit — sees them in the form the blueprint states them.

Two hypotheses were carried, deliberately, across three waves of parallel work, under the
standing rule that a missing result is named rather than hidden by a placeholder:
...
theorem jordan_curve_theorem {C : Set Plane} (hC : IsJordanCurve C) : IsSeparating C :=
  by
    ...
    let r : SchoenfliesJordanCurveTheorem.UnitCircle → Plane :=
    ...
    · simpa [SchoenfliesJordanCurveTheorem.inside, Schoenflies.inside, hr_range] using
        (SchoenfliesJordanCurveTheorem.isPathConnected_inside hr_cont hr_inj).isConnected
    · simpa [SchoenfliesJordanCurveTheorem.outside, Schoenflies.outside, hr_range] using
        (SchoenfliesJordanCurveTheorem.isPathConnected_outside hr_cont).isConnected
    · simpa [SchoenfliesJordanCurveTheorem.inside, Schoenflies.inside, hr_range] using
        SchoenfliesJordanCurveTheorem.frontier_inside hr_cont hr_inj
    · simpa [SchoenfliesJordanCurveTheorem.outside, Schoenflies.outside, hr_range] using
        SchoenfliesJordanCurveTheorem.frontier_outside hr_cont hr_inj

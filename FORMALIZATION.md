...
2. construction of the global Riemannian area measure and globalization of
   the planar area formula through a compatible atlas. The intrinsic
   pointwise `J₂`, its multiplicative chain rule and planar identification,
   plus the exact weighted measure and area inequality on one parametrized
   chart, are now verified;
